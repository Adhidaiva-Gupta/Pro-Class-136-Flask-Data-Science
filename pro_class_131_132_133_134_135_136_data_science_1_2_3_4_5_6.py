# -*- coding: utf-8 -*-
"""Pro Class 131 - 132 - 133 - 134 - 135 - 136 Data Science 1 - 2 - 3 - 4 - 5 - 6.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xj2D4GiZtfuBvApihmUddLKhmu4-JlSW
"""
...
"""Let's take a look at the our headers again"""

print(headers)

"""Here we have a header called planet_type, Let's see how many different kinds of planets we're dealing with"""
...
goldilock_planets = list(suitable_planets) #We will leave suitable planets list as it is
...
speed_supporting_planets = list(suitable_planets) # We will leave suitable planets list as it is
